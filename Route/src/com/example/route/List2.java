...
public class List2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String>ar=new ArrayAdapter<String>(List2.this, android.R.layout.select_dialog_item ,s);
		lt.setAdapter(ar);
		lt.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
				...
				Toast.makeText(List2.this, ""+s, 111).show();
				Intent i1=new Intent(List2.this,Route.class);
				i1.putExtra("p", s);
				startActivity(i1);
			}
		});	
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_list2, menu);
		return true;
	}
